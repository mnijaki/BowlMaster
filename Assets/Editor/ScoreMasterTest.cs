...
public class ScoreMasterTest
{
  ...
  public void T01Bowl23()
  {
    int[] rolls = { 2,3 };
    int[] frames = { 5 };
    Assert.AreEqual(frames.ToList(),ScoreMaster.RoundsScores(rolls.ToList()));
  }
  ...
  public void T16TestGutterGame()
  {
    ...
    Assert.AreEqual(totalS.ToList(),ScoreMaster.CumulativeRoundsScores(rolls.ToList()));
  }
  ...
  [Test]
  public void MN_MultiStrikes()
  {
    int[] rolls = { 5,5,10,1,2 };
    int[] frames = { 20,13,3 };
    Assert.AreEqual(frames.ToList(),ScoreMaster.RoundsScores(rolls.ToList()));
  }

} // End of ScoreMasterTest